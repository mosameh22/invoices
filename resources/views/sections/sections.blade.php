							...
							<div class="card-body">
								<div class="table">
									<table id="example1" class="table key-buttons text-md-nowrap">
										<thead>
											<tr>
                                                <th class="border-bottom-0">رقم المسلسل</th>
											...
											<tr>
												...
												<td>
                                                    <a class="modal-effect btn btn-sm btn-info" data-effect="effect-scale"
                                                       ...
                                                       data-descreption="{{ $section->descreption }}" data-toggle="modal" href="#exampleModal2"
				...
				<div class="modal-content modal-content-demo">
					...
					<div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name ="section_name" id="exampleFormControlInput1" placeholder="اسم القسم">
                          </div>
                          <div class="mb-3">
                            <label for="exampleFormControlInput1" class="form-label">ملاحظات </label>
                            <textarea class="form-control"  name= "descreption" id="exampleFormControlInput2" placeholder="ملاحظات"></textarea>
                          </div>
...
<script>
    $('#exampleModal2').on('show.bs.modal', function(event) {
        ...
        var descreption = button.data('descreption')
        var modal = $(this)
        modal.find('.modal-body #id').val(id);
        modal.find('.modal-body #section_name').val(section_name);
        modal.find('.modal-body #descreption').val(descreption);
    })
</script>
<script>
