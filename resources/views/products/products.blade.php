							...
							<div class="card-header pb-0">
								<div class="d-flex justify-content-between">
                                    <div class="card custom-card">
                                        <a class="btn ripple btn-primary " data-target="#exampleModal" data-toggle="modal" href="">اضافة منتج </a>
								</div>
							</div>
							<div class="card-body">
								<div class="table-responsive">
									<table class="table text-md-nowrap" id="example1">
										<thead>
											<tr>
												<th class="wd-15p border-bottom-0">رقم المسلسل</th>
										...
										<tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><button class="btn btn-outline-success btn-sm"
                                                    ...
                                                    data-descreption="{{$product->descreption}}" data-toggle="modal"
                    ...
                    <form action='products/update' method="post">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="descreption" cols="20" rows="5" id='descreption'
